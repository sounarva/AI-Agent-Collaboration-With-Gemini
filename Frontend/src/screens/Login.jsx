    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-linear-to-tr from-[#181818] via-[#1F2430] to-[#23272f] p-4">
            <div className="w-full max-w-md rounded-2xl shadow-2xl bg-[#23272f] px-8 py-10 flex flex-col items-center">
                <h2 className="text-3xl sm:text-4xl font-extrabold mb-2 text-white tracking-tight text-center">Welcome Back!</h2>
                <p className="mb-8 text-gray-400 text-center text-sm">Sign in to access your account</p>
                <form
                ...
                <div className="flex justify-center items-center align-middle mt-8 gap-2">
                    ...
                    <Link to="/register" className="text-blue-400 font-semibold text-sm hover:underline">Create One</Link>
                </div>
            </div>
        </div>
    )
